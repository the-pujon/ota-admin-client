...
const DynamicForm: React.FC = () => {
  ...
  return (
    <div className=" mt-6 flex h-screen items-start justify-center ">
      <div className=" flex flex-col justify-center items-center  w-1/2">
        <span className=" text-2xl font-semibold uppercase bg-slate-600 w-full text-center text-slate-200 p-2 rounded-sm">Package Submit FORM</span>
        ...
        >
          ...
          <div>
            ...
            />
            {errors.title && (
              <p className="text-red-500 text-sm text-red">{errors.title.message}</p>
            )}
          </div>
          {/* Title End */}
          {/* About */}
          <div>
            ...
            />
            {errors.about && (
              <p className="text-red-500 text-sm text-red">{errors.about.message}</p>
            )}
          </div>
          {/* About End */}
          {/* Price */}
          <div>
            ...
            />
            {errors.price && (
              <p className="text-red-500 text-sm text-red">{errors.price?.message}</p>
            )}
          </div>
          {/* Price End*/}
          {/* Highlights */}
          ...
          <div>
            ...
            {errors.images && (
              <p className="text-red-500 text-red">{errors.images.message}</p>
            )}
            <button
              type="button"
        ...
        >
          ...
          <Button
            ...
            containerStyles={`${loading? "bg-slate-400":"bg-orange-deep"} w-full  p-2 text-white uppercase rounded-md `}
          />
        </form>
      </div>
      </div>
